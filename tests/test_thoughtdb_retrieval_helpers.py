...
from mi.thoughtdb import retrieval as R
...
class TestThoughtDbRetrievalHelpers(unittest.TestCase):
    def test_claim_active_and_valid_filters_redirects(self) -> None:
        ...
        self.assertFalse(R._claim_active_and_valid(v, "cl_dup", as_of_ts="2026-02-23T00:00:00Z"))
    ...
    def test_claim_active_and_valid_filters_superseded_and_retracted(self) -> None:
        ...
        self.assertFalse(R._claim_active_and_valid(v, "cl_old", as_of_ts="2026-02-23T00:00:00Z"))
        self.assertFalse(R._claim_active_and_valid(v, "cl_bad", as_of_ts="2026-02-23T00:00:00Z"))
    ...
    def test_claim_active_and_valid_honors_valid_window(self) -> None:
        ...
        self.assertTrue(R._claim_active_and_valid(v, "cl_window", as_of_ts="2026-02-23T00:00:00Z"))
        self.assertFalse(R._claim_active_and_valid(v, "cl_window", as_of_ts="2026-02-19T00:00:00Z"))
        self.assertFalse(R._claim_active_and_valid(v, "cl_window", as_of_ts="2026-02-24T00:00:00Z"))
    ...
    def test_node_active_filters_redirects_and_retractions(self) -> None:
        ...
        self.assertFalse(R._node_active(v, "nd_dup"))
        self.assertFalse(R._node_active(v, "nd_bad"))
